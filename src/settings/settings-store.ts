...
function isStoredSettings(value: unknown): value is Pick<AppSettings, 'language' | 'show_piano' | 'show_guitar'> & { readonly ear_gym_streak?: unknown; readonly volume?: unknown; readonly tempo_bpm?: unknown; readonly last_root?: unknown; readonly last_formula?: unknown; readonly guided_start_completed?: unknown } {
...
function normalizeSettings(value: Pick<AppSettings, 'language' | 'show_piano' | 'show_guitar'> & { readonly ear_gym_streak?: unknown; readonly volume?: unknown; readonly tempo_bpm?: unknown; readonly last_root?: unknown; readonly last_formula?: unknown; readonly guided_start_completed?: unknown }): AppSettings {
  ...
  return { language: value.language, show_piano: value.show_piano, show_guitar: value.show_guitar, ear_gym_streak, volume, tempo_bpm, last_root, last_formula, guided_start_completed }
}
...
export function createSettingsStore(initial_language: Language = 'en', diagnostics: EventLoggerPort = { log: () => undefined }): SettingsStore {
  const fallback_settings: AppSettings = { language: initial_language, show_piano: true, show_guitar: true, ear_gym_streak: 0, volume: 0.7, tempo_bpm: 120, last_root: 4, last_formula: 'dorian', guided_start_completed: false }
