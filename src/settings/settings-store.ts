...
function log_diagnostic(diagnostics: EventLoggerPort, event_name: string, attributes: Readonly<Record<string, string | number | boolean>>): void {
 ...
 function normalizeSettings(value: Pick<AppSettings, 'language' | 'show_piano' | 'show_guitar'> & { readonly note_naming?: unknown; readonly show_bass?: unknown; readonly show_ukulele?: unknown; readonly show_scale_description?: unknown; readonly ear_gym_streak?: unknown; readonly volume?: unknown; readonly tempo_bpm?: unknown; readonly guitar_tuning_semitones?: unknown; readonly bass_tuning_semitones?: unknown; readonly ukulele_tuning_semitones?: unknown; readonly last_root?: unknown; readonly last_formula?: unknown; readonly guided_start_completed?: unknown }): AppSettings {
  ...
  return { language: value.language, note_naming, show_piano: value.show_piano, show_guitar: value.show_guitar, show_bass, show_ukulele, show_scale_description, ear_gym_streak, volume, tempo_bpm, guitar_tuning_semitones, bass_tuning_semitones, ukulele_tuning_semitones, last_root, last_formula, guided_start_completed }
}
