...
import { createStringedInstrumentViewModel, getTuningNote, type StringedInstrumentMappingOptions, type StringedInstrumentViewModel, type StringedInstrumentString } from './guitar-view-model'
...
export function createUkuleleViewModel(scale_instance: ScaleInstance, generation_id: number, fret_count = 12, tuning = STANDARD_UKULELE_TUNING, options: StringedInstrumentMappingOptions = {}): StringedInstrumentViewModel {
