...
export const SCALE_FORMULAS: readonly ScaleFormula[] = [
  {
    ...
    semitone_offsets: [0, 2, 4, 5, 7, 9, 11],
    characteristic_degrees: [7],
    degree_roles: diatonic_roles(7)
  },
  {
    id: 'natural_minor',
    name: 'Natural minor',
    degrees: [1, 2, 3, 4, 5, 6, 7],
    semitone_offsets: [0, 2, 3, 5, 7, 8, 10],
    characteristic_degrees: [6],
    degree_roles: diatonic_roles(6)
  },
  {
    id: 'dorian',
    name: 'Dorian',
    degrees: [1, 2, 3, 4, 5, 6, 7],
    semitone_offsets: [0, 2, 3, 5, 7, 9, 10],
    characteristic_degrees: [6],
    degree_roles: diatonic_roles(6)
  },
  {
    ...
    name: 'Phrygian',
    degrees: [1, 2, 3, 4, 5, 6, 7],
    semitone_offsets: [0, 1, 3, 5, 7, 8, 10],
    characteristic_degrees: [2],
    degree_roles: diatonic_roles(2)
  },
  {
    id: 'lydian',
    name: 'Lydian',
    degrees: [1, 2, 3, 4, 5, 6, 7],
    semitone_offsets: [0, 2, 4, 6, 7, 9, 11],
    characteristic_degrees: [4],
    degree_roles: diatonic_roles(4)
  },
  {
    id: 'mixolydian',
    name: 'Mixolydian',
    degrees: [1, 2, 3, 4, 5, 6, 7],
    semitone_offsets: [0, 2, 4, 5, 7, 9, 10],
    characteristic_degrees: [7],
    degree_roles: diatonic_roles(7)
  },
  {
    ...
    name: 'Locrian',
    degrees: [1, 2, 3, 4, 5, 6, 7],
    semitone_offsets: [0, 1, 3, 5, 6, 8, 10],
    characteristic_degrees: [5],
    degree_roles: {
      ...diatonic_roles(5),
      5: ['characteristic', 'chord_tone']
    }
  },
  {
    id: 'major_pentatonic',
...
export function get_formula(formula_id: FormulaId): ScaleFormula {
